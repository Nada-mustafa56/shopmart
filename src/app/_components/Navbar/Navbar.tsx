    ...
    <nav className="shadow-md bg-white sticky top-0 z-50">
      <div className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div className="flex items-center gap-8">
          <Link href="/">
            {/* placeholder بديل للوجو */}
            <div className="w-44 h-10 bg-gray-300 flex items-center justify-center text-gray-600 font-bold cursor-pointer hover:scale-105 transition-transform duration-300">
              LOGO
            </div>
          </Link>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            {data ? (
              <>
                <h1 className='bg-green-500 rounded-md border px-4 py-2 font-bold text-white'>
                  Hi {data.user?.name}
                </h1>  
